...
PATH_TO_DIRECTORY_RESULT_1 = 'C:\\Users\\tom\\usd_input_output_operation\\Data\\Deals\\Deals_short_1'
PARTS_SIZE = 200000000
RESULT_FILE_NAME = 'currancy_to_USD_rates.csv'

PATH_TO_DIRECTORY_DEALS_1 = 'C:\\Users\\tom\\usd_input_output_operation\\Data\\Deals\\Deals_short_1'
...
if __name__ == '__main__':
    ...
    pair_curr_rate_by_hours = get_pair_curr_rate_by_hours(PATH_TO_DIRECTORY_DEALS_1)
    
    file_list = os.listdir(PATH_TO_DIRECTORY_DEALS_1)
    
    for file in file_list:
        df = csv_to_df(file, PATH_TO_DIRECTORY_DEALS_1)
        ...
        for frame in frame_list:
            frame.to_csv(PATH_TO_DIRECTORY_RESULT_1 + '\\' +'Deals_USD_short_' + str(index) + '_' + file, index=False)
